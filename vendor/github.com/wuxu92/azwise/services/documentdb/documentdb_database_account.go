...
var _ azwise.ResourceKnowledge = (*DocumentDBDatabaseAccount)(nil)
...
func (s *DocumentDBDatabaseAccount) CheckForceNew(oldBody, newBody map[string]interface{}) bool {
	...
	oldBackup := azwise.ExtractStringValue(oldBody, "properties.backupPolicy.type")
	newBackup := azwise.ExtractStringValue(newBody, "properties.backupPolicy.type")
...
func init() { azwise.Register(NewDocumentDBDatabaseAccount()) }
