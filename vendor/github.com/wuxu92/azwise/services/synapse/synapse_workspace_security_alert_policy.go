...
// SynapseWorkspaceSecurityAlertPolicy provides resource knowledge for
// Microsoft.Synapse/workspaces/securityAlertPolicies.
//
// Mirrors azurerm_synapse_workspace_security_alert_policy (ID
...
//     WorkspaceSecurityAlertPolicy (segment casing "securityAlertPolicies").
//
// Notes:
//   - disabled_alerts is an array of enum strings (Sql_Injection, Sql_Injection_Vulnerability,
//     Access_Anomaly, Data_Exfiltration, Unsafe_Action); per-element enum validation is not
//     expressible as an array-element path — documented here, no rule emitted.
type SynapseWorkspaceSecurityAlertPolicy struct {
	azwise.BaseKnowledge
}

var _ azwise.ResourceKnowledge = (*SynapseWorkspaceSecurityAlertPolicy)(nil)

func NewSynapseWorkspaceSecurityAlertPolicy() *SynapseWorkspaceSecurityAlertPolicy {
...
func init() { azwise.Register(NewSynapseWorkspaceSecurityAlertPolicy()) }
