...
var _ azwise.ResourceKnowledge = (*StorageAccount)(nil)
...
func skuZoneMigration(oldBody, newBody map[string]interface{}) bool {
	oldSku := strings.ToUpper(azwise.ExtractStringValue(oldBody, "sku.name"))
	newSku := strings.ToUpper(azwise.ExtractStringValue(newBody, "sku.name"))
...
func accountKindRequiresReplace(oldBody, newBody map[string]interface{}) bool {
	oldKind := azwise.ExtractStringValue(oldBody, "kind")
	newKind := azwise.ExtractStringValue(newBody, "kind")
...
func largeFileShareDisabled(oldBody, newBody map[string]interface{}) bool {
	oldLFS := azwise.ExtractStringValue(oldBody, "properties.largeFileSharesState")
	newLFS := azwise.ExtractStringValue(newBody, "properties.largeFileSharesState")
...
func init() { azwise.Register(NewStorageAccount()) }
