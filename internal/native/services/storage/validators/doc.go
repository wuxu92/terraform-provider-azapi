...
// Microsoft.Storage native resources — semantic rules a bicep type or the azwise
...
// typegraph.Validator(storagevalidators.StorageAccountIPRule) — so a rename or a
// deletion is a compile error at the callsite, not a silent bad string. The
