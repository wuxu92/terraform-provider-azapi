...
// TestDataFactoryAcceptance is the Ginkgo entry point for the Microsoft.DataFactory
...
// fast and offline.
func TestDataFactoryAcceptance(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Microsoft.DataFactory native acceptance suite")
}
