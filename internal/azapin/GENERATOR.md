...
`internal/azapin/generated/<service>/<name>_gen.go` (package `<service>`), where
...
(e.g. `generated/storage/storage_account_gen.go`). The `_gen.go` suffix — together
...
`generator.FileName`. Each service package self-registers into `generated.Registry`
via `generated.Register` in `init()`; the `generated/all` package blank-imports
